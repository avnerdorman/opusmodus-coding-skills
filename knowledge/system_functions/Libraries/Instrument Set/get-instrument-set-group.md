Opusmodus                                                   get-instrument-set-group   1

get-instrument-set-group instrument-set group
[Function]
...
Returns a list of instrument names in the given instrument-set and in the given
group.
