Opusmodus                                            get-sound-set-controller-group   1

get-sound-set-controller-group sound-set group
[Function]
...
Returns a list of program names in the given program group and in the given sound-set.
...
=> 57
Opusmodus                                    get-sound-set-controller-group   2
