Opusmodus                                            get-sound-set-program-groups   1

get-sound-set-program-groups sound-set
[Function]
...
Returns all the program group names in the given sound-set.
...
=> (general lsb pedal)
Opusmodus                                     get-sound-set-program-groups   2
