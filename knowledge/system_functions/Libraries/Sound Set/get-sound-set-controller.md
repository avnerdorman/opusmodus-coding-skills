Opusmodus                                                get-sound-set-controller   1

get-sound-set-controller sound-set controller
[Function]
...
Returns the value in the given controller name and in the given sound-set.
...
=> (general lsb pedal)
Opusmodus                                         get-sound-set-controller   2
