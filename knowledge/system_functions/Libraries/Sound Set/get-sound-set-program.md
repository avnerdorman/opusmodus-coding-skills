Opusmodus                                                   get-sound-set-program   1

get-sound-set-program sound-set program
[Function]
...
Returns the given program in the given sound-set. The value is either a program
number or a 2-list of the form: (<bank-select><program-number>).
...
=> (general lsb pedal)
Opusmodus                                           get-sound-set-program   2
