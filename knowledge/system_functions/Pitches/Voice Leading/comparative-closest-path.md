...
comparative-closest-path sequence &key start ambitus
                                             ambitus-chord section exclude seed
...
The function COMPARATIVE-CLOSEST-PATH returns a series of chords taking the
comparatively closest path to the previous chord, derived from randomising the pitch order
of a given chord before the ‘ nd closest interval’ process.
...
(gen-loop 4 (comparative-closest-path
             '(b4g4e4c4 c5a4e4f4 b4a4f4d4 b4g4e4d4) :start '(c3c4c5c5))
         :seed 23)
