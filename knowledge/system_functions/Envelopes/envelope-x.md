...
The function returns a list of the x-values from the envelope. The function rst pairs up
the elements of the input envelope using the PAIR-UP function. It then loops through
these pairs, collecting the rst element (the x-value) from each pair into a new list.


Examples:
(envelope-x '(0 1 2 0 4 1))
=> (0 2 4)
...
(envelope-x env)
=> (0.0 1.0 1.01 4.01 4.0200005 11.02
    11.030001 14.030001 14.040001 27.04)
                   fi
                                                                              fi
