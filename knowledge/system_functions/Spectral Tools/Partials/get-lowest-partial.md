Opusmodus                                                                 get-lowest-partial   1

get-lowest-partial partials &key type
[Function]
...
This function returns the lowest partial value of a given partials data. OPUSMODUS can
work with two types of spectral data. A two point data: frequency and amplitude
and a three point data: duration, frequency and amplitude.

Example with two point data:

(get-lowest-partial '(1178.9136 3.57E-4
                       2548.98 5.6E-5
                       1304.0593 3.87E-4
                       1651.8359 0.001961))
=> (1178.9136 3.57E-4)
...
(get-lowest-partial '(0.274875 1178.9136 3.57E-4
...
(get-lowest-partial '(0.274875 1178.9136 3.57E-4
                    ...
                    :type :amp)
=> (0.137438 2548.98 5.6E-5)
Opusmodus                                                           get-lowest-partial      2
