Opusmodus                                                                          gen-sawtooth   1

gen-sawtooth res freq amplitude &key phase modulation
[Function]
...
The GEN-SAWTOOTH function generates a sequence of vectors that describe and simulate
the characteristics of a sawtooth wave.

(gen-sawtooth 32 1 0.5)
=> (-0.5 -0.46875 -0.4375 -0.40625 -0.375
    -0.34375 -0.3125 -0.28125 -0.25 -0.21875
    -0.1875 -0.15625000000000006 . . .)
...
another wave produced by the GEN-SAWTOOTH function.

(list-plot
 (gen-sawtooth 120 3 0.5 :modulation (gen-sawtooth 120 5 0.2)))
Opusmodus                                                            gen-sawtooth     3
...
(list-plot
 (gen-sawtooth 120 1 '(0.5 0.2 0.1)
  :modulation (gen-sawtooth 120 1 0.3)))
Opusmodus                                                                  gen-sawtooth     4
...
(list-plot
 (gen-sawtooth 120 3 '(0.5 0.2 0.1)
  :modulation (gen-sawtooth 120 1 0.9 :phase 90)))
...
(vector-to-pitch '(g3 g5)
 (gen-sawtooth 120 1 '(0.5 0.2 0.1)
  :modulation (gen-sawtooth 120 1 0.3 :phase 90)))
=> (g3 ds4 fs4 gs3 ds4 fs4 gs3 e4 fs4 a3 e4 fs4 as3 e4
    fs4 as3 f4 g4 b3 f4 g4 c4 f4 g4 c4 f4 g4 cs4 fs4 g4
    d4 fs4 g4 ds4 fs4 g4 ds4 g4 gs4 e4 g4 gs4 f4 g4 gs4
    fs4 gs4 gs4 g4 gs4 gs4 g4 gs4 gs4 gs4 a4 a4 a4 a4
    a4 as4 a4 a4 b4 as4 a4 c5 as4 a4 cs5 as4 as4 d5 b4
    as4 ds5 b4 as4 e5 c5 as4 f5 c5 as4 fs5 c5 b4 g5 cs5
    b4 c5 as4 a4 c5 as4 a4 cs5 as4 as4 d5 b4 as4 ds5 b4
    as4 ds5 b4 as4 e5 c5 as4 f5 c5 as4 fs5 c5 b4 g5 cs5 b4)
fi
Opusmodus                                                                 gen-sawtooth   5
...
Score Example:
(setf size 120)
(setf vector (gen-sawtooth size 1 '(0.5 0.4 0.3 0.6)
...
(display-midi (compile-score 'sawtooth))
