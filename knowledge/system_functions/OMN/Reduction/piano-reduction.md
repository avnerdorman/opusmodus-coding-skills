Opusmodus                                                                   piano-reduction   1

piano-reduction voices &key dissolve-voices
[Function]

Arguments and Values:
voices                    lists of list (voices).
dissolve-voices           NIL or T. The default is NIL.


Description:

The function PIANO-REDUCTION returns a reduction a work originally written for
orchestra and rearrange for a single instrument (typically piano). A reduction for solo piano is
sometimes called a piano reduction or piano score.
...
(piano-reduction (list violin1 violin2 viola cello))

With :dissolve-voices on:

(setf reduction (piano-reduction (list violin1 violin2 viola cello)
                                 :dissolve-voices t))

Preview Score with Piano and Grand Layout:
